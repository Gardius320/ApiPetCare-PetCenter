...
namespace PetCare.Migrations
{
    ...
    [Migration("20260731171134_MakeMedicalRecordFieldsOptional")]
    partial class MakeMedicalRecordFieldsOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetCare.Domain.Models.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PetCare.Domain.Models.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PetCare.Domain.Models.MedicalRecords", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("VeterinarianUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PetCare.Domain.Models.InvoiceItem", b =>
                {
                    b.HasOne("PetCare.Domain.Models.Invoice", null)
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PetCare.Domain.Models.MedicalRecords", b =>
                {
                    ...
                    b.HasOne("PetCare.Domain.Identity.ApplicationUser", "Veterinarian")
                        .WithMany()
